...
export default function Verify() {
	...
	return (
		<>
			<SEO
				title="Verify Your Account | Travel Link"
				description="Verify your Travel Link account to start connecting with travel partners. Secure your profile and gain full access to a community of like-minded travelers. Complete the verification process and embark on new adventures with Travel Link."
			...
			<Container maxWidth="xs" sx={{ padding: "2rem" }}>
				...
				<Stack gap={"1rem"} alignItems={"center"}>
					<Typography variant="h5">OTP code verification</Typography>
